...
public class GeraltApplication extends Application {
    private static ApplicationComponent applicationComponent;
    private static WomanComponent womanComponent;
    private static VideoComponent videoComponent;
    ...
    public static VideoComponent createVideoComponent(final long id) {
        videoComponent = applicationComponent.plus(new VideoModule(id));
